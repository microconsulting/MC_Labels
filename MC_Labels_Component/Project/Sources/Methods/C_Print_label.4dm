...
Case of 
	...
	: ($File_path="form:@")
		...
		//If (Bool($file.exists))
		//$file:=ZIP Read archive($file).root.file("Project/Sources/TableForms/"+String($Lon_table)+"/"+$Txt_form+"/form.4DForm")
		//End if 
		//Else 
		//$file:=Folder(fk database folder; *).file("Project/Sources/TableForms/"+String($Lon_table)+"/"+$Txt_form+"/form.4DForm")
		//End if 
		//If ($file.exists)
